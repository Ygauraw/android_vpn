...
* A VPN profile. {@hide}
*/
public class OpenvpnProfileFile implements Parcelable, Serializable {
...
public static final Parcelable.Creator<OpenvpnProfileFile> CREATOR = new Parcelable.Creator<OpenvpnProfileFile>() {
public OpenvpnProfileFile createFromParcel(Parcel in) {
OpenvpnProfileFile p = new OpenvpnProfileFile();
p.readFromParcel(in);
return p;
}

public OpenvpnProfileFile[] newArray(int size) {
return new OpenvpnProfileFile[size];
}
};
