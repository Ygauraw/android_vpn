 ...
 */
public class VpnEditorFile extends PreferenceActivity {
	private static final int MENU_SAVE = Menu.FIRST;
	private static final int MENU_CANCEL = Menu.FIRST + 1;

	static final String KEY_PROFILE = "openvpn_profile";
	private static final String TAG = VpnEditorFile.class.getSimpleName();

	private OpenvpnProfileFile mProfile;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mProfile = (OpenvpnProfileFile) ((savedInstanceState == null) ? getIntent()
				.getParcelableExtra(VpnSettingsFile1.KEY_VPN_PROFILE)
		...
		addPreferencesFromResource(R.xml.vpn_edit_file);
		...
		mCert.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
			...
			public boolean onPreferenceChange(Preference pref, Object data) {
				try {
					String path = Util.getPath(VpnEditorFile.this,
					...
					try {
						...
						if (cert != null)
							...
							Util.showLongToastMessage(VpnEditorFile.this,
			...
			if (profileChanged()) {
				DialogFragment dialog = new DialogFragment() {
					...
					public Dialog onCreateDialog(Bundle savedInstanceState) {
						return new AlertDialog.Builder(VpnEditorFile.this)
	...
	private boolean validateAndSetResult() {
		...
		if (profileChanged()) {
			Intent intent = new Intent(this, VpnSettingsFile1.class);
			intent.putExtra(VpnSettingsFile1.KEY_VPN_PROFILE, (Parcelable) mProfile);
	...
	public String validate() {
		...
		if (!mProfile.getUserAuth() && mProfile.getCertName() == null)
			return String.format(getString(R.string.vpn_error_miss_entering_cert),
					getString(R.string.vpn_a_ca_certificate));
		if (!mProfile.getUserAuth() && mProfile.getUserCertName() == null)
			return String.format(getString(R.string.vpn_error_miss_entering_cert),
